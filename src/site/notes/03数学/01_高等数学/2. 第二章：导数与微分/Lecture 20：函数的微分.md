---
{"title":"Lecture 20：函数的微分","tags":["数学"],"categories":null,"date":"2023-12-22","dg-publish":true,"permalink":"/03数学/01_高等数学/2. 第二章：导数与微分/Lecture 20：函数的微分/","dgPassFrontmatter":true}
---
...
## 1.1 微分的定义
### 1.1.1 什么是微分
![Pasted image 20250607165030.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250607165030.png)
![Pasted image 20250607170736.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250607170736.png)
**为什么需要微分**
...
+ 例子
	...
	+ 即变化率和平方的部分无关，可以被省略掉；
		+ 图示：
			+ ![Pasted image 20231222204211.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020231222204211.png)
			+ 蓝色的部分为次要部分，可以省略掉；
			+ 只需要保留绿色的部分；
	+ 这对于误差的估计很有用；
...
+ 微分：是指函数在某一点处（趋近于无穷小）的变化量，是一种**变化的量。**
+ 关于它们的符号
...
![Pasted image 20250607171932.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250607171932.png)
![Pasted image 20250607172226.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250607172226.png)
### 1.1.3 可微分与可导
##### **定理**： #可微与可导的关系
...
+ 所以：验证了可导 -> 可微分；
**可微判别**
![Pasted image 20250607171842.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250607171842.png)
## 1.2 连续、可导、可微之间的关系
**图示**
![Pasted image 20240317192744.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020240317192744.png)
...
+ 推论：二阶导数存在不等于二阶导极限存在；
![Pasted image 20240317190353.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020240317190353.png)
...
### 1.3.1 古典微分学
**古典微分学的特点**
![Pasted image 20240115172004.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020240115172004.png)
1. dy 和 dx 表示的是自变量和因变量的具体的变化
2. 根据想象中的无穷小这个东西，定义了切线
3. 然后将切线的斜率定义为导数
![Pasted image 20240115171900.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020240115171900.png)
dx 到底是什么，一会为0，一会又不为0？？为什么一个量会有两种不同形态，而且还能完全没道理的自由转换。

### 1.3.2 极限微分学
极限被发明了出来。相应的什么是无穷小，也有了确切的、具体的定义。无穷小终于不再是幽灵了，被光明正大的纳入数学体系中；
![Pasted image 20240115172055.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020240115172055.png)
...
极限微分学的计算：
![Pasted image 20240115172447.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020240115172447.png)