---
{"title":"Lecture 13：间断点及其分类","tags":["数学","间断点"],"categories":null,"date":"2024-03-11","dg-publish":true,"permalink":"/03数学/01_高等数学/1. 第一章：函数、极限、连续/Lecture 13：间断点及其分类/","dgPassFrontmatter":true}
---
...
+ 2. 第二类间断点：左、右极限中**至少有**一个不存在；
	...
	+ 振荡间断点：比如在 x 趋向于 0 时，$sin(1/x)$ 为振荡间断点；
	+ 无穷和震荡是第二类当中常见的两种，但是不一定只有这两种，也可能既不是无穷、也不是震荡；
![Pasted image 20250808110838.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250808110838.png)
