---
{"tags":[],"dg-publish":true,"permalink":"/03数学/02_线性代数/6. 第六章：二次型/Lecture 23：正定二次型/正定二次型/","dgPassFrontmatter":true}
---
...
+ （2）再用充分条件；
	+ 注意：`q=0` 无法推出来 `p=n` 
注意区分：
![Pasted image 20250731173352.png](/img/user/01%E9%99%84%E4%BB%B6/Pasted%20image%2020250731173352.png)